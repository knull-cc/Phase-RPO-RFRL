#!/usr/bin/env bash
# ETTh2 (7 variates, hourly). Usage: bash scripts/ETTh2.sh [--model X ...]
...
for pred_len in 96 192 336 720; do
  python -u run.py \
    ...
    --data ETTh2 --root_path ./dataset/ETT-small/ --data_path ETTh2.csv --freq h \
    --model_id ETTh2_${seq_len}_${pred_len} --model "$model_name" \
